...
public class OsmrBackendMatchServiceTest {

	OsmrBackendMatchService osmrBackendSpy;
	...
	class TestFetchStepsFromChunk {
		...
		public void setUp() throws IOException {
			...
			osmrBackendMatchService = new OsmrBackendMatchService(baseUrl);
		}
		...
		public void testFetchStepsFromChunk_ChunkSizing() throws InterruptedException {
			...
			List<Long> ids = osmrBackendMatchService.fetchStepsFromChunk(chunk).block();

			RecordedRequest request = mockWebServer.takeRequest();
			assertEquals(
					"/match/v1/bike/52.520007,13.404954;42.520007,23.404954?steps=true&radiuses=31.12;18.88&timestamps=1693842834;1693842835",
					request.getPath());
