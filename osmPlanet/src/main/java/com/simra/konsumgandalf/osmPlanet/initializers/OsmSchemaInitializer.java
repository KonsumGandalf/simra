...
public class OsmSchemaInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		try {
			...
			String tableCheckQuery = "SELECT EXISTS (" + "SELECT FROM information_schema.tables "
			...
			if (Boolean.TRUE.equals(tableExists)) {
				...
				String primaryKeyCheckQuery = "SELECT COUNT(*) " + "FROM information_schema.table_constraints tc "
						+ "JOIN information_schema.key_column_usage kcu "
						+ "ON tc.constraint_name = kcu.constraint_name " + "WHERE tc.table_name = 'planet_osm_line' "
